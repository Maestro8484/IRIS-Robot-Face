// mouth_tft.cpp — ILI9341 2.8" TFT mouth driver (hardware SPI2, Teensy 4.1)
//
// Pins: MOSI=35 (SPI2), SCK=37 (SPI2), CS=36 (SPI2), DC=8, RST=4, BL=14
// ILI9341_t3 selects SPI2 automatically when MOSI=35 / SCK=37 are passed.
...
// ── TFT instance (hardware SPI2 — MOSI=35, SCK=37 map to SPI2 on T4.1) ──────
